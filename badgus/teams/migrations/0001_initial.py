...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadgeTeam'
        db.create_table(u'teams_badgeteam', (
            (u'team_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teamwork.Team'], unique=True, primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'teams', ['BadgeTeam'])


    def backwards(self, orm):
        # Deleting model 'BadgeTeam'
        db.delete_table(u'teams_badgeteam')
