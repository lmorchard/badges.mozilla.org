...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.team'
        db.add_column(u'badger_badge', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teamwork.Team'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.team'
        db.delete_column(u'badger_badge', 'team_id')
    ...
    models = {
        ...
        u'badger.deferredaward': {
            ...
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'ftv9fx'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
